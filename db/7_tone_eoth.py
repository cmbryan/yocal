...
while yr <= yr_final:
    ...
    #              Festal - Festal - 1 - 4 - 5 - 7 - 8 - 10 - Festal 
    # Place this sequence in a tuple:

    seq = ('Eothinon of the feast','Eothinon of the feast','Eothinon 1','Eothinon 4','Eothinon 5','Eothinon 7','Eothinon 8','Eothinon 10','Eothinon of the feast')
