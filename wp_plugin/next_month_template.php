...
if (!function_exists('format_lect')) {
        ...
        $ffile = $upload_path."/".$Yr."-".$Mn.'_fathers.txt';
...
Some seafoods, e.g. squid, crab, roe and prawn, are permitted.<br><br>";
        ...
        $A4file = "https://www.yorkorthodox.org/wp/wp-content/uploads/".$Yr."-".$Mn.'_A4.pdf';
        $A5file = "https://www.yorkorthodox.org/wp/wp-content/uploads/".$Yr."-".$Mn.'_A5.pdf';
        if (file_exists($upload_path."/".$Yr."-".$Mn.'_A4.pdf')) {
