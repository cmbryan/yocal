...
if (!function_exists('format_lect')) {
        ...
        $ffile = $upload_path."/".date('Y-m').'_fathers.txt';
...
Some seafoods, e.g. squid, crab, roe and prawn, are permitted.<br><br>";
        ...
        $A4file = "https://www.yorkorthodox.org/wp/wp-content/uploads/".date('Y-m').'_A4.pdf';
        $A5file = "https://www.yorkorthodox.org/wp/wp-content/uploads/".date('Y-m').'_A5.pdf';
        if (file_exists($upload_path."/".date('Y-m').'_A4.pdf')) {
        ...
        $Ackfile = $upload_path."/Acknowledgements.txt";
